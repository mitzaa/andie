...
class EditableImage {
    ...
    /**
     * Export an image to a specified location.
     * 
     * Exports an image to the file provided as a parameter. If a file type is given
     * in the name then it uses that to write the file, otherwise <code>.jpg</code>
     * is used.
     * 
     * @param imageFilename The file location to save the image to.
     * @throws Exception If something goes wrong.
    ...
    public void export(String imageFilename) throws Exception {
        ...
        if (!extension.equals("jpg") && !extension.equals("png")) {
            extension = "png";
            try {
                imageFilename = imageFilename.substring(0, imageFilename.indexOf(".")) + ".png";
     ...
     * @exception NullPointerException catches this error when no image is open
     */
    public void apply(ImageOperation op) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Open an image to get started", "No image selected", 2);
        }
        FileActions.unSavedChanges = true;
     ...
     * </p>
     * 
     * @exception EmptyStackException Catches error when there is no image selected
     *                                or all undo operations left have been done on
     *                                the image.
     */
    public void undo() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "No image is selected or nothing to undo", "Cannot redo changes", 2);
        }
    ...
    public void redo() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "No image is selected or nothing to redo", "Cannot redo changes", 2);
        }
